        ...
        >
            <div className="container pt-16 pb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    >
                        <p className="text-[19px] font-bold tracking-tight mb-3" style={{ color: "#1D1D1F" }}>
                            Bharath Packers<br />
                            <span style={{ color: "#0071E3" }}>&amp; Movers</span>
                        </p>
                        <p className="text-[15px] leading-[22px] max-w-[28ch]" style={{ color: "#6E6E73" }}>
                            Bangalore's trusted partner for safe, timely, and stress-free relocation.
                        </p>
                    ...
                    >
                        ...
                        <ul className="space-y-2">
                            {serviceAreas.map((area) => (
                                <li key={area} className="text-[15px]" style={{ color: "#6E6E73" }}>
                                    {area}
                                </li>
                            ))}
                        </ul>
                        ...
                        <ul className="space-y-2">
                            {interstateAreas.map((city) => (
                                <li key={city} className="text-[15px]" style={{ color: "#6E6E73" }}>
                                    {city}
                                </li>
                            ))}
                        </ul>
                    ...
                    >
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <Phone size={16} className="mt-0.5 shrink-0" style={{ color: "#0071E3" }} />
                                <div>
                                    <a
                            ...
                            <li className="flex items-start gap-3">
                                <Mail size={16} className="mt-0.5 shrink-0" style={{ color: "#0071E3" }} />
                                <a
                                    href="mailto:hello@bharathpackers.in"
                                    className="text-[15px] transition-colors duration-[180ms]"
                                    style={{ color: "#6E6E73" }}
                                    onMouseEnter={(e) => (e.currentTarget.style.color = "#0071E3")}
                                    onMouseLeave={(e) => (e.currentTarget.style.color = "#6E6E73")}
                                >
                                    hello@bharathpackers.in
                                </a>
                            </li>
                            <li className="flex items-start gap-3">
                                <MapPin size={16} className="mt-0.5 shrink-0" style={{ color: "#0071E3" }} />
                ...
                >
                    <p>© {new Date().getFullYear()} Bharath Packers & Movers. All rights reserved.</p>
