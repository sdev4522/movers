  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="rounded-xl px-3 py-2 text-[13px] font-medium text-white whitespace-nowrap"
            style={{
      ...
      <motion.a
        ...
        className="wa-pulse flex items-center justify-center w-14 h-14 rounded-full text-white shadow-lg"
