...
const steps = [
    {
        number: 1,
        title: "Enquire",
        description: "Fill out our quick quote form or call us. We respond within a few hours.",
    },
    {
        number: 2,
        title: "Survey & Quote",
        description: "We assess your needs — in person or virtually — and give you a detailed, no-surprises quote.",
    },
    {
        number: 3,
        title: "Pack & Move",
        description: "Our trained crew arrives on schedule, packs everything carefully, and transports it safely.",
    },
    {
        number: 4,
        title: "Safe Delivery",
        description: "Unloading, placement, and a final walkthrough — we don't leave until you're satisfied.",
    },
];
                        ...
                        >
                            ...
                            <div className="flex items-center w-full mb-6">
                                <div
                                    ...
                                    style={{ background: "#0071E3", boxShadow: "0 4px 16px rgba(0,113,227,0.3)" }}
                                >
                                    {step.number}
                                </div>
                                {i < steps.length - 1 && (
